...
//电阻屏芯片连接引脚	   
#define PEN  		PAin(0)  	//T_PEN       old pc5
#define DOUT 		PAin(6)   	//T_MISO   old pb14
#define TDIN 		PAout(7)  	//T_MOSI   old pb15
#define TCLK 		PAout(5)  	//T_SCK    old pb13
#define TCS  		PAout(1)  	//T_CS    old pb12
