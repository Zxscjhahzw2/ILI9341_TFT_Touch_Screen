...
u8 TP_Read_XY(u16 *x,u16 *y)
{
	...
	*x=xtemp;
	*y=ytemp;
//	*x = (u16)(tp_dev.xfac * xtemp + tp_dev.xoff);
//	*y = (u16)(tp_dev.yfac * ytemp + tp_dev.yoff);
...
u8 TP_Init(void)
{
  GPIO_InitTypeDef  GPIO_InitStructure;	
	...
	else
	{
	  ...
	  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB|RCC_AHB1Periph_GPIOC|RCC_AHB1Periph_GPIOF|RCC_AHB1Periph_GPIOA, ENABLE);//使能GPIOB,C,F时钟

    //GPIOB14初始化设置
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;//PB14 设置为上拉输入
    ...
    GPIO_Init(GPIOA, &GPIO_InitStructure);//初始化
		    ...
		    //GPIOC5初始化设置
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0;//PC5 设置为上拉输入
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;//输入模式
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
    GPIO_Init(GPIOA, &GPIO_InitStructure);//初始化
		...
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1| GPIO_Pin_5| GPIO_Pin_7;//PB0设置为推挽输出
